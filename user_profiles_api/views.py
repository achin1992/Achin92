...
from user_profiles_api import serializers
from user_profiles_api import models
from user_profiles_api import permissions
...
class HelloAPIView(APIView):
    ...
    def get(self, request, format=None):
        ...
        an_apiview = [
            "Different methods are GET, POST, PUT, PATCH, DELETE.",
            "Should be used as per case.",
        ]
...
class UserLoggedInViewSet(viewsets.ModelViewSet):
